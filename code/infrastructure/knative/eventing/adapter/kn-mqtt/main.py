...
#         print(f"creating KNMQTTClient: {self.config}")
...
#     #     print("run")        
#     #     self.client = MessageClientManager.create(
#     #         config=MessageClientConfig(
#     #             type="mqtt",
#     #             config={"hostname": self.config.mqtt_broker, "port": self.config.mqtt_port}
#     #         )
#     #     )
#     #     print(f'run: client {self.client}')#, topics: {self.config.mqtt_topic_subscriptions.split("\n")}')
#     #     topics = self.config.mqtt_topic_subscriptions.split("\n")
...
#     #                 r.raise_for_status()
#     #         except InvalidStructuredJSON:
#     #             print(f"INVALID MSG: {ce}")
#     #         except httpx.HTTPError as e:
#     #             print(f"HTTP Error when posting to {e.request.url!r}: {e}")
...
class KNMQTTClient():
    ...
    async def send_to_mqtt_loop(self):
        ...
        #     except Exception as e:
        #         print("send_to_mqtt", extra={"reason": e})    
