...
class ShellyPro2(Controller):
    """docstring for ShellyPro2."""

    metadata = {
        "attributes": {
            "make": {"type": "char", "data": "Shelly"},
            "model": {"type": "char", "data": "ShellyPro2"},
            "host": {"type": "char", "data": "localhost"},
            "description": {
                "type": "char",
                "data": "Shelly Pro 2 Smart Switch",
            },
            "tags": {"type": "char", "data": "testing, Shelly, ShellyPro2, serial, tcp, ethernet, sensor"},
            "format_version": {
                "type": "char",
                "data": "1.0.0"
            },
    ...
    def __init__(self, config=None, **kwargs):
        ...
        self.controller_id_prefix = "shellypro2"
        ...
        # self.metadata = ShellyPro2.metadata
        self.controller_definition_file = "Shelly_ShellyPro2_controller_definition.json"
    ...
    def configure(self):
        ...
        super(ShellyPro2, self).configure()
        ...
        try:
            ...
            self.controller_id_prefix = conf.get("controller_id_prefix", "shellypro2")
            ...
            # path_map = dict()
            # for name, val in ShellyPro2.metadata["paths"].items():
            ...
            self.logger.debug("ShellyPro2:configure", extra={"error": e})
    ...
    async def deal_with_data(self, client, data):
        if data['data']['device'] == 'shelly':
            toggle_topic = 'shellypro2/command/switch:'
            ...
            for name in self.settings.get_settings().keys():
                if not self.settings.get_health_setting(name):
                    ...
                    try:
                        ...
                        if name in ["channel_0_power", "channel_1_power"]:
...
async def test_task():
    while True:
        ...
        logger.info("ShellyPro2_test_task", extra={"test": "ShellyPro2 task"})
...
async def main(server_config: ServerConfig = None):
    ...
    logger = logging.getLogger("interface::ShellyPro2")
    ...
    iface.enable()
    logger.debug("Starting Shelly Pro 2 Controller")
    ...
    while do_run:
        logger.debug("ShellyPro2.run", extra={"do_run": do_run})
        await asyncio.sleep(1)
