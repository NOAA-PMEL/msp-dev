...
class ShellyPro1(Controller):
    """docstring for ShellyPro1."""

    metadata = {
        "attributes": {
            "make": {"type": "char", "data": "Shelly"},
            "model": {"type": "char", "data": "ShellyPro1"},
            "host": {"type": "char", "data": "localhost"},
            "description": {
                "type": "char",
                "data": "Shelly Pro 1 Smart Switch",
            },
            "tags": {"type": "char", "data": "testing, Shelly, ShellyPro1, serial, tcp, ethernet, sensor"},
            "format_version": {
                "type": "char",
                "data": "1.0.0"
            },
    ...
    def __init__(self, config=None, **kwargs):
        ...
        # self.metadata = ShellyPro1.metadata
    ...
    def configure(self):
        ...
        try:
            ...
            # path_map = dict()
            # for name, val in ShellyPro1.metadata["paths"].items():
            ...
            self.logger.debug("ShellyPro1:configure", extra={"error": e})
    ...
    async def deal_with_data(self, client, data):
        if data['data']['device'] == 'shelly':
            toggle_topic = 'shellypro1/command/switch:'
...
async def test_task():
    while True:
        ...
        logger.info("ShellyPro1_test_task", extra={"test": "ShellyPro1 task"})
