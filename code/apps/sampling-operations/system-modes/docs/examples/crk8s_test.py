platform_payload_crk8s01 = (
    {
        ...
        "interface": {
            "power-input": ["input-24v-ups", "input-24v", "input-110v"],
            "network": ["internal", "external"],
            "sample-input": ["sample-line-01"],
        },
    },
)
...
platform_variable_map_payload03 = {
    ...
    "metadata": {
        "name": "CRK83Payload01",  # variable map name
        "platform": "CRK83Payload01",  # platform name
    },
    "valid-config-time": "2025-10-21T00:00:00Z",
    "variable_groups": {
        "main": {"timebase": 1},
        # "sizing": {"timebase": 30},
    },
    "variables": {
        "cn": {
            ...
            "source": {
                "concentration": {  # source variable name
                    ...
                    "source_id": "AerosolDynamics::MAGIC250Mock::mock",
            ...
            "index_method": [
                "round",
                "average",
            ],  # method used to map to time base in decreasing order
            "attributes": {
        ...
        #         #     "data": "number_concentration_of_aerosol_particles_at_stp_in_air"
        #         # },
        #         "units": {"type": "string", "data": "l min-1"},
        #     },
        # },
        # "total_flow_sp": {
        #     "type": "float",
        ...
        #     "direct-value": {"source-variable": "temperature"},
        #     "variable_group": "main",
        #     # "timebase": 1, # timebase for mapped variable - will map to this even timebase
        #     "index_method": [
        #         "round",
        ...
        #     },
        #     # if source-variable name is same as variable name, don't need this. Will override name if present
        #     "direct-value": {"source-variable": "temperature_sp"},
        #     "variable_group": "main",
        #     # "timebase": 1, # timebase for mapped variable - will map to this even timebase
        #     "index_method": [
        #         "round",
...
crk8spayload01_sampling_layout = {
    "version": "v1",
    "kind": "SamplingLayout",
    "metadata": {"name": "MSPPaylaod03", "platform": "MSPPayload03"},
    ...
    "interfaces": {
        ...
        "smps-serial": {"interface-id": "Lantronix::??::", "port": "10001"},
        "i2c-bus": {
            "kind": "Interface",
    ...
    "devices": {
        "cpc": {
            "kind": "Sensor",
            "device-id": "AerosolDynamics::MAGIC250Mock::mock",
            "interface": {"default": "cpc-serial"},
            "power": {"controller": "sensor-pdu", "controller-variable": "outlet-1"},
        },
        "aps": {
            "kind": "Sensor",
            "device-id": "TSI::APS::??",
            "interface": {"default": "aps-serial"},
            "power": {"controller": "sensor-pdu", "controller-variable": "outlet-2"},
        },
        "opc": {
            "kind": "Sensor",
            "device-id": "Handix::POPS::???",
            "interface": {"default": "opc-serial"},
            "power": {"controller": "sensor-pdu", "controller-variable": "outlet-3"},
        },
        "smps": {
            "kind": "Sensor",
            "device-id": "AerosolDynamics::SpiderMagic::002",
            "interface": {"default": "smps-serial"},
            "power": {"controller": "sensor-pdu", "controller-variable": "outlet-4"},
        },
        "sample_t_rh": {
            "kind": "Operational",
            "device-id": "IST::HYT271::???",
            "interface": {"default": "i2c-bus"},
            "power": {"controller": "i2c-relay", "controller-variable": "channel-1"},
        },
        "total_flow": {
            "kind": "Operational",
            "device-id": "IST::Flow::???",
        ...
        "total_flow_pump": {
            "kind": "Operational",
            "device-id": "mfg::pump::???",
            "interface": {"pwm": "total-flow-pwm", "rpm": "total-flow-rpm"},
            "power": {"controller": "sensor-pdu", "controller-variable": "outlet-1"},
        },
        "case_trh_1": {
            "kind": "Operational",
...
#     "attributes": {
#         "platform": {"type": "string", "data": "MSPPayload03"},
#         "dataset": {"type": "string", "data": "AerosolPhysics"},
#         "dataset_type": {"type": "string", "data": "main"},
#         "description": {
#             "type": "string",
...
#         },
#         "format_version": {"type": "string", "data": "1.0.0"},
#         "variable_types": {"type": "string", "data": "main, operational, calibration"},
#         "valid_time": {"type": "string", "data": "2025-06-26T19:00:00Z"},
#         "timebase": {"type": "int", "data": 1},
#         # "serial_number": {
#         #     "type": "string",
#         #     "data": ""
#         # },
...
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "cn"},
#             },
#         },
#     },
# }
...
#     "attributes": {
#         "platform": {"type": "string", "data": "MSPPayload03"},
#         "dataset": {"type": "string", "data": "sizing"},
#         "dataset_type": {"type": "string", "data": "sizing"},
#         "description": {
#             "type": "string",
#             "data": "Main one second data from Aerosol Physics payload during BEACONS",
#         },
...
#         "change_log": {"type": "string", "data": ""},
#     },
#     "dimensions": {"time": 0, "smps_diameter": 0, "opc_diameter": 0, "aps_diameter": 0},
#     "variables": {
#         "time": {
#             "type": "str",
#             "shape": ["time"],
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "smps_diameter"},
#             },
#         },
#         "smps_dNdlogDp": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "smps_dNdlogDp"},
#             },
#         },
#         "smps_intN": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "smps_intN"},
#             },
#         },
#         "opc_diameter": {
#             "type": "float",
#             "shape": ["time", "opc_diameter"],
#             "attributes": {
#                 "variable_type": {"type": "string", "data": "main"},
#                 # "long_name": {
#                 #     "type": "char",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "opc_diameter"},
#             },
#         },
#         "opc_dNdlogDp": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "opc_dNdlogDp"},
#             },
#         },
#         "opc_intN": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "opc_intN"},
#             },
#         },
#         "aps_diameter": {
#             "type": "float",
#             "shape": ["time", "aps_diameter"],
#             "attributes": {
#                 "variable_type": {"type": "string", "data": "main"},
#                 # "long_name": {
#                 #     "type": "char",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "aps_diameter"},
#             },
#         },
#         "aps_dNdlogDp": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "aps_dNdlogDp"},
#             },
#         },
#         "aps_intN": {
#             "type": "float",
...
#                 # },
#                 "platform_varaiable_map": {"type": "string", "data": "MSPPayload03"},
#                 "platform_variable": {"type": "string", "data": "aps_intN"},
#             },
#         },
#     },
# }
