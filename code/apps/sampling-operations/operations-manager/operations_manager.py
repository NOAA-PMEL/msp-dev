...
class OperationsManagerConfig(BaseSettings):
    host: str = "0.0.0.0"
    port: int = 8080
    debug: bool = True
    # knative_broker: str = (
...
class OperationsManager:
    """docstring for OperationsManager."""

    def __init__(self):
        self.logger = logging.getLogger(self.__class__.__name__)
        self.logger.setLevel(logging.DEBUG)
        self.logger.debug("OperationsManager instantiated")
        ...
        self.config = OperationsManagerConfig()
        self.configure()
        print("here:7")
        ...
        print("OperationsManager: init: here:8")
...
if __name__ == "__main__":
    ...
    # app.run()
    config = OperationsManagerConfig()
    print(config)
